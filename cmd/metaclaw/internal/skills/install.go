...
func newInstallCommand(installerFn func() (*skills.SkillInstaller, error)) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `
metaclaw skills install sipeed/picoclaw-skills/weather
metaclaw skills install --registry clawhub agent-browser
metaclaw skills install --zip ./agent-browser.zip --name agent-browser
`,
